...
<div class="reviewDiv">
	<div class="reviewProductInfoDiv">
		<div class="reviewProductInfoImg"><img width="400px" height="400px" src="img/productSingle_middle/${p.imageName}"></div>
		<div class="reviewProductInfoRightDiv">
			...
			<table class="reviewProductInfoTable">
				<tr>
					<td width="75px">促销价格:</td>

					<td><span class="reviewProductInfoTablePrice">￥<fmt:formatNumber type="number" value="${p.promotePrice}" minFractionDigits="2"/></span> 元 </td>


				</tr>

				<tr>
					<td width="75px">原价格:</td>
	...
	<c:if test="${param.showonly!=true}">
		...
		<form method="post" action="foredoreview">
			...
			<div class="makeReviewButtonDiv">
				...
				<input type="hidden" name="price_value" value="${p.promotePrice}">
